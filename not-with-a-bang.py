...
popular_results = twitter_bot.search(q="\"not with a bang\"", count=100, lang="en", result_type="popular", tweet_mode="extended")

mixed_results = twitter_bot.search(q="\"not with a bang\"", count=100, lang="en", result_type="mixed", tweet_mode="extended")
